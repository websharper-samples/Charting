...
{
 "use strict";
 var Global,RadarChart,WebSharper,Charting,Renderers,ChartJs,Chart,Obj,Charts,RadarChart$1,Arrays,Pervasives,Color,UI,Doc,JavaScript,Pervasives$1,ChartJsInternal,Operators,CompositeChart,Unchecked,Object,EventTarget,Node,DomUtility,Seq,ADataSet,ChartConfig,SeriesChartConfig,ColorConfig,SC$1,Control,FSharpEvent,SC$2,View,SC$3,Docs,HtmlModule,attr,AttrModule,Element,HTMLElement,Enumerator,T,Option,Slice,BatchUpdater,Util,Seq$1,IntelliFactory,Reactive,Reactive$1,Reactive$2,List,T$1,Event,Event$1,Random,PolarData,DocElemNode,CharacterData,An,Client,Settings,Abbrev,Mailbox,AttrProxy,Attrs,Collections,List$1,Attrs$1,Dyn,WindowOrWorkerGlobalScope,Docs$1,RunState,NodeSet,Snap,Anims,SC$4,Disposable,HashSet,Fresh,SC$5,Concurrency,AppendList,Observer,SC$6,Easing,AsyncBody,SC$7,CT,HashSet$1,Elt,Array,SC$8,Scheduler,CancellationTokenSource,DomNodes,Updates,Error,OperationCanceledException,Lazy,HashSetUtil,SC$9,LazyExtensionsProxy,LazyRecord,Queue,Runtime,Math,console,Date;
 Global=self;
 RadarChart=Global.RadarChart=Global.RadarChart||{};
 ...
 RadarChart$1=Charts.RadarChart=Charts.RadarChart||{};
 ...
 SC$1=Global.StartupCode$WebSharper_Charting$Renderers=Global.StartupCode$WebSharper_Charting$Renderers||{};
 Control=WebSharper.Control=WebSharper.Control||{};
 FSharpEvent=Control.FSharpEvent=Control.FSharpEvent||{};
 SC$2=Global.StartupCode$WebSharper_Charting$Charts=Global.StartupCode$WebSharper_Charting$Charts||{};
 ...
 Reactive$2=Pervasives.Reactive=Pervasives.Reactive||{};
 ...
 Date=Global.Date;
 RadarChart.Main=function()
 {
  var labels;
  labels=["Eating","Drinking","Sleeping","Designing","Coding","Cycling","Running"];
  Doc.RunById("main",ChartJs.Render(Chart.Combine([Chart.Radar$1(Arrays.zip(labels,[28,48,40,19,96,27,100])).__WithFillColor(new Color({
   $:0,
   $0:151,
   $1:187,
   $2:205,
   ...
   $:2,
   $0:"darkblue"
  })).__WithTitle("Alice"),Chart.Radar$1(Arrays.zip(labels,[65,59,90,81,56,55,40])).__WithFillColor(new Color({
   $:0,
   $0:220,
   $1:220,
   $2:220,
 ...
 RadarChart$1=Charts.RadarChart=Runtime.Class({
  ...
  {
   return new RadarChart$1.New(this.dataset,ChartConfig.New(title),this.scfg,this.ccfg);
  },
  WebSharper_Charting_Charts_IColorChart_1$WithPointColor:function(color)
  {
   var i;
   return new RadarChart$1.New(this.dataset,this.cfg,this.scfg,(i=this.ccfg,ColorConfig.New(color,i.PointHighlightFill,i.PointHighlightStroke,i.PointStrokeColor)));
  },
  WebSharper_Charting_Charts_ISeriesChart_1$WithStrokeColor:function(color)
  {
   var i;
   return new RadarChart$1.New(this.dataset,this.cfg,(i=this.scfg,SeriesChartConfig.New(i.XAxis,i.YAxis,i.FillColor,color,i.IsFilled)),this.ccfg);
  },
  WebSharper_Charting_Charts_ISeriesChart_1$WithFillColor:function(color)
  {
   var i;
   return new RadarChart$1.New(this.dataset,this.cfg,(i=this.scfg,SeriesChartConfig.New(i.XAxis,i.YAxis,color,i.StrokeColor,i.IsFilled)),this.ccfg);
  },
 ...
 RadarChart$1.New=Runtime.Ctor(function(dataset,cfg,scfg,ccfg)
 {
  Obj.New.call(this);
 ...
 ChartJsInternal.RenderCombinedRadarChart=function(chart,size,cfg,window$1)
 {
  return ChartJsInternal.withNewCanvas(size,function(canvas)
  {
   ...
   rendered=new Global.Chart(canvas,{
    type:"radar",
    data:{
     datasets:Arrays.ofSeq(Seq.map(function(chart$1)
     {
      var initials,r;
 ...
 {
  return Reactive$2.SequenceOnlyNew(Seq.choose(Global.id,Seq.mapi(function(i,data)
  {
   return data.$==0?null:{
    $:1,
    $0:Reactive$1.Select(data.$0,function(d)
    {
     return[i,d];
    })
   };
 ...
 {
  SC$2.$cctor();
  return SC$2.defaultChartConfig;
 };
 Charts.defaultSeriesChartConfig=function()
 {
  SC$2.$cctor();
  return SC$2.defaultSeriesChartConfig;
 };
 Charts.defaultColorConfig=function()
 {
  SC$2.$cctor();
  return SC$2.defaultColorConfig;
 };
 ...
 SC$2.$cctor=function()
 {
  ...
  SC$2.defaultChartConfig=ChartConfig.New("Chart");
  SC$2.defaultSeriesChartConfig=SeriesChartConfig.New("x","y",new Color({
   $:0,
   $0:220,
   $1:220,
   $2:220,
  ...
  SC$2.defaultColorConfig=ColorConfig.New(new Color({
   $:0,
   $0:220,
   $1:220,
   $2:220,
  ...
  SC$2.defaultPolarData=(rand=new Random.New(),function(label)
  {
 ...
 Reactive$2.SequenceOnlyNew=function(streams)
 {
  var m;
  m=List.ofSeq(streams);
  return m.$==1?Reactive$2.sequence(Reactive$1.Select(m.$0,function(v)
  {
   return[v];
  }),m.$1):Reactive$1.Return([]);
 };
 Reactive$2.sequence=function(acc,a)
 {
  var xs,x;
  while(true)
   if(a.$==1)
    {
     ...
     acc=(function(acc$1,x$1)
     {
      return function(f)
      {
       return Reactive$1.CombineLast(acc$1,x$1,function($1,$2)
       {
        return(f($1))($2);
       });
      };
